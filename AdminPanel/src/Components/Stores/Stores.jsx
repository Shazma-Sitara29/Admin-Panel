...
const StoresManagement = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, name: 'New Store 1', location: 'Location 1', contact: '1234567890', type: 'Grocery' },
    { id: 2, name: 'New Store 2', location: 'Location 2', contact: '0987654321', type: 'Electronics' },
  ]);
  ...
  const acceptNotification = (notification) => {
    setStores([...stores, { id: notification.id, ...notification }]);
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-6">
        ...
        {notifications.length > 0 ? (
          notifications.map((notification) => (
            <div key={notification.id} className="flex justify-between items-center bg-gray-200 p-3 rounded-lg mb-2">
              <span>{notification.name} - {notification.location}</span>
              <button
